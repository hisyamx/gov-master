    ...
    <div class="w3l-homeblock2 w3l-homeblock5 py-5">
        <div class="container pt-md-4 pb-md-5">
            ...
            <p class="mb-sm-5 mb-4 max-width">Lorem ipsum dolor sit amet elit. Id quaerat amet ipsum sunt et quos
                dolorum.</p>
            <div class="row">
                <div class="col-lg-6">
                            ...
                            <div class="col-sm-5 position-relative">
                                <a href="#blog-single.html" class="image-mobile">
                                    <img class="card-img-bottom d-block radius-image-full"
                                        src="assets/images/beauty7.jpg" alt="Card image cap">
                                </a>
                            </div>
                            <div class="col-sm-7 card-body blog-details align-self">
                                <a href="#blog-single.html" class="blog-desc">Why you need a Spa Day, Reasons to get a
                                    Package
                                </a>
                ...
                <div class="col-lg-6 mt-lg-0 mt-4">
                    <div class="bg-clr-white hover-box">
                        <div class="row">
                            ...
                            <div class="col-sm-7 card-body blog-details align-self">
                                <a href="#blog-single.html" class="blog-desc">Winter: 4 Ways to feel Great during the
                                    Cold Weather
                                </a>
                                <div class="author align-items-center">
                ...
                <div class="col-lg-6 mt-4">
                    <div class="bg-clr-white hover-box">
                        <div class="row">
                            ...
                            <div class="col-sm-7 card-body blog-details align-self">
                                <a href="#blog-single.html" class="blog-desc">Key to Glowing Skin: 5 tips for hydration
                                    and protection
                                </a>
                                <div class="author align-items-center">
                                    <img src="assets/images/a3.jpg" alt="" class="img-fluid rounded-circle">
                ...
                <div class="col-lg-6 mt-4">
                    <div class="bg-clr-white hover-box">
                        <div class="row">
                            ...
                            <div class="col-sm-7 card-body blog-details align-self">
                                <a href="#blog-single.html" class="blog-desc">Take steps to beautiful Summer Feet with
                                    Spa experience </a>
                                <div class="author align-items-center">
                ...
                <div class="col-lg-6 mt-4">
                    <div class="bg-clr-white hover-box">
                        <div class="row">
                            ...
                            <div class="col-sm-7 card-body blog-details align-self">
                                <a href="#blog-single.html" class="blog-desc">Tried and Tested: Thermal Spa and Turkish
                                    Experience
                                </a>
                                <div class="author align-items-center">
                                    <img src="assets/images/a1.jpg" alt="" class="img-fluid rounded-circle">
                ...
                <div class="col-lg-6 mt-4">
                    <div class="bg-clr-white hover-box">
                        <div class="row">
                            ...
                            <div class="col-sm-7 card-body blog-details align-self">
                                <a href="#blog-single.html" class="blog-desc">3 Incredible Facials, Makeups you Simply
                                    have to try</a>
                                <div class="author align-items-center">
                                    <img src="assets/images/a3.jpg" alt="" class="img-fluid rounded-circle">
                                    <ul class="blog-meta">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 item">
                    <div class="card">
                        ...
                        <div class="card-body blog-details">
                            <a href="blog-single.html" class="blog-desc">All the fashion influencers giving us WFH
                                outfit inspiration
                            </a>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body blog-details">
                            <a href="blog-single.html" class="blog-desc">The Satin Skirt &amp; How to Wear it all year
                                round fashion
                            </a>
                            <p>Lorem ipsum dolor sit amet consectetur ipsum adipisicing elit. Quis
                                vitae sit.</p>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body blog-details">
                            <a href="blog-single.html" class="blog-desc">From the classic (jeans) to the not-so-classic
                                (printed tops)
                            </a>
                            <p>Lorem ipsum dolor sit amet consectetur ipsum adipisicing elit. Quis
                                vitae sit.</p>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body blog-details">
                            <a href="blog-single.html" class="blog-desc">An easy Guide to buying Denim &amp; My
                                favourite styles
                            </a>
                            <p>Lorem ipsum dolor sit amet consectetur ipsum adipisicing elit. Quis
                                vitae sit.</p>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body blog-details">
                            <a href="blog-single.html" class="blog-desc">What I’ll be Wearing this Party Season &amp;
                                the Festive edit
                            </a>
                            <p>Lorem ipsum dolor sit amet consectetur ipsum adipisicing elit. Quis
                                vitae sit.</p>
