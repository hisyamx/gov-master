        ...
        <div class="text11 py-lg-5 py-md-4">
            ...
            <div class="container">
                <div class="blog-title px-md-5">
                    <h3 class="title-big">Create an Art that shows the beauty in everyone’s ideas of flaws.
                    </h3>
                    <ul class="blog-list">
                        <li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="text11-content">
                            <h4 class="mt-sm-3"> How to create an Art that shows the beauty in everyone’s ideas of
                                flaws.</h4>
                            <p class="mt-4 mb-3">Fusce faucibus ante vitae justo efficitur elementum. Donec et ipsum
                                faucibus
                                arcu
                                ipsum elementum, luctus justo. ac purus semper. Fusce faucibus ante vitae justo
                                efficitur
                                sed et
                                elementum. Donec ipsum
                                faucibus arcu elementum, luctus justo. ac purus semper. Fusce faucibus ante vitae justo
                                efficitur
                                elementum. Donec ipsum faucibus arcu vitae justo efficitur elementum.</p>
                            <p class="mb-3">Fusce faucibus ante vitae justo efficitur elementum. Donec ipsum faucibus
                                arcu
                                elementum, luctus
                            ...
                            <h5 class="quote">For dull and lifeless skin, mix apple juice with honey. Apply a thin layer
                                to your face, and leave it for 5 minutes.
                                <footer class="blockquote-footer mt-3"> Kelvin edison </footer>
                            </h5>
                            ...
                            <div class="sing-post-thumb mb-lg-5 mb-4 row pt-3">
                                <div class="col-md-6">
                                    <a href="#url"><img src="{{asset('/assets')}}/images/fashion1.jpg" class="img-fluid" alt=""></a>
                                </div>
                                <div class="col-md-6 mt-md-0 mt-3 align-self">
                                    <p class="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis
                                        tempora
                                        quisquam incidunt accusantium culpa voluptatibus, nulla qui a quibusdam porro?
                                        luctus
                                        justo. ac purus semper. Fusce faucibus ante vitae justo efficitur elementum.
                                        Donec
                                        ipsum.</p>
                                </div>
                            </div>
                            <h4 class="mb-md-4 mb-3">Fusce faucibus ante vitae justo efficitur</h4>
                            <p class="mb-4">Lorem faucibus fusce ante vitae justo efficitur elementum. Donec ipsum
                                faucibus
                                arcu elementum, luctus justo. ac purus semper. Fusce faucibus ante vitae justo efficitur
                                elementum. Donec ipsum faucibus. Donec ipsum faucibus arcu Donec ipsum faucibus
                                arcu elementum, luctus justo. ac purus semper. </p>
                            ...
                            <h4 class="mb-md-4 mb-3">Quisque sagittis lacus eu lorem sodales </h4>
                            <p class="mb-3">Lorem faucibus fusce ante vitae justo efficitur elementum. Donec ipsum
                                faucibus
                                arcu elementum, luctus justo. ac purus semper. Fusce faucibus ante vitae justo efficitur
                                elementum. Donec ipsum faucibus. Donec ipsum faucibus arcu.</p>
                            <p class="mb-3">Fusce faucibus arcu faucibus ante vitae justo efficitur
                                elementum. Donec ipsum faucibus. Donec ipsum faucibus arcu.</p>
                            ...
                            <div class="social-share-blog mt-5">
                                ...
                                <ul class="column3 tags m-0 p-0">
                                    ...
                                    <li><a href="#url" class="btn-small">Fashion</a></li>
                                    <li><a href="#url" class="btn-small">Beauty</a></li>
                                ...
                                <ul class="column3 social m-0 p-0">
                                    ...
                                    <li><a href="#linkedin" class="linkedin"><span class="fa fa-linkedin"></span></a>
                                    </li>
                        ...
                        <aside class="sidebar">
                            ...
                            <div class="sidebar-widget sidebar-blog-category">
                                <div class="author">
                                    ...
                                    <div class="author-detalis">
                                        <a href="#author" class="author-image"><img src="{{asset('/assets')}}/images/a2.jpg"
                            ...
                            <div class="sidebar-widget sidebar-blog-category">
                                ...
                                <ul class="blog-cat">
                                    ...
                                    <li><a href="#url">Fashion and Style</a></li>
                                    <li><a href="#url">Food and wellness</a></li>
                            ...
                            <div class="sidebar-widget popular-posts">
                                ...
                                <article class="post">
                                    <figure class="post-thumb"><img src="{{asset('/assets')}}/images/beauty8.jpg" alt=""></figure>
                                    <div class="text"><a href="blog-single.html">
                                            4 Ways to feel Great during the Cold Weather</a>
                                    </div>
                                    <div class="post-info">June 14, 2020</div>
                                </article>

                                <article class="post">
                                    <figure class="post-thumb"><img src="{{asset('/assets')}}/images/food3.jpg" alt=""></figure>
                                    <div class="text"><a href="blog-single.html">
                                            How to Make the Best Japanese Shokupan Veg Bread
                                        </a></div>
                                    <div class="post-info">June 13, 2020</div>
                                </article>

                                <article class="post">
                                    <figure class="post-thumb"><img src="{{asset('/assets')}}/images/beauty2.jpg" alt=""></figure>
                                    <div class="text"><a href="blog-single.html">

                                            How to get Beautiful coloring Highlights this weak</a>
                                    </div>
                                    <div class="post-info">June 12, 2020</div>
                                </article>
                                ...
                                <div class="sidebar-sticky-fix">
                                    ...
                                    <div class="sidebar-widget sidebar-blog-category archive">
                                        ...
                                        <ul class="blog-cat twitter-feed">
                                            <li><a href="#url"> Creating an Art that shows the beauty in everyone’s
                                                    ideas of flaws.
                                                    . #beauty #style #art #creative…</a></li>
                                            <li><a href="#url">See our lifestyle and beauty posts on twitter. #LifeStyle
                                                    #Beauty
                                                </a></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="comments">
                            ...
                            <div class="comments-grids">
                                <div class="media-grid">
                                    <div class="media">
                                        <a class="comment-img" href="#url"><img src="{{asset('/assets')}}/images/a1.jpg"
                                ...
                                <div class="media-grid">
                                    <div class="media">
                                        <a class="comment-img" href="#url"><img src="{{asset('/assets')}}/images/a2.jpg"
                                                class="img-responsive" width="100px" alt="placeholder image"></a>
                                        <div class="media-body comments-grid-right">
                                            <h5>Charlie</h5>
                                            <ul class="p-0 comment">
                                            ...
                                            <div class="media mt-4 mb-0 border-0 px-0 pb-0">
                                                <a class="comment-img" href="#url"><img src="{{asset('/assets')}}/images/a3.jpg"
