    ...
    <div class="w3l-contact-10 py-5" id="contact">
        <div class="form-41-mian pt-lg-4 pt-md-3 pb-md-4">
            <div class="container">
                <div class="heading">
                    <h3 class="category-title mb-3">Hubungi Kami</h3>
                    <p class="mb-md-5 mb-4">Jika Anda memiliki pertanyaan tentang layanan kami, silakan untuk menghubungi kami menggunakan formulir di bawah ini.</p>
                </div>
                                ...
                                <section class="tab-content">
                                    <div class="contact-type">
                                        <div class="address-grid mb-4">
                                            <h6>Alamat</h6>
                                            <p>Kawasan Kantor Pusat Pemerintahan Provinsi Kalimantan, Kota Kalimantan, Kalimantan.</p>
                                        </div>
                                        <div class="address-grid mb-4">
                                            <h6>Email DPRD</h6>
                                            <a href="mailto:mail@example.com" class="link1">dprd@kalimantanprov.go.id</a>
                                        </div>
                                        <div class="address-grid mb-4">
                                            <h6>Email Sekwan</h6>
                                            <a href="mailto:mail@example.com" class="link1">setdprd@kalimantanprov.go.id</a>
                                        </div>
                                        <div class="address-grid mb-4">
                                            <h6>Email Admin</h6>
                                            <a href="mailto:mail@example.com" class="link1">dprdkalimantanprov@gmail.com</a>
                                        </div>
