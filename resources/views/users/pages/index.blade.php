                ...
                <div class="col-lg-3 col-md-4">
                    <div class="top-pic">
                        <div class="card-body blog-details">
                            ...
                            <a href="/fraksipdip" class="blog-desc">Partai PDI Perjuangan
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="top-pic">
                        <div class="card-body blog-details">
                            ...
                            <a href="/fraksigolkar" class="blog-desc">Partai Golongan Rakyat
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="top-pic">
                        <div class="card-body blog-details">
                            ...
                            <a href="/fraksipan" class="blog-desc">Partai PAN
                            </a>
                        </div>
                    </div>
                </div>
